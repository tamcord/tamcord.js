...
class Channel extends Base {
    constructor(client, data, immediatePatch = true) {
         ...
         * @type {ChannelType}
         */
        this.type = type !== null && type !== void 0 ? type : 'UNKNOWN';
        /**
                ...
                switch (data.type) {
                    ...
                    case ChannelTypes.GUILD_PRIVATE_THREAD: {
                        ...
                        if (!allowUnknownGuild)
                            (_a = channel.parent) === null || _a === void 0 ? void 0 : _a.threads.cache.set(channel.id, channel);
                        break;
                    }
                }
                if (channel && !allowUnknownGuild)
                    (_b = guild.channels) === null || _b === void 0 ? void 0 : _b.cache.set(channel.id, channel);
            }
        }
        return channel;
    }
