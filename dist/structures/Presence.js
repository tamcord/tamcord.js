...
class Activity {
    constructor(presence, data) {
         ...
         * @type {?string}
         */
        this.syncID = (_a = data.sync_id) !== null && _a !== void 0 ? _a : null;
        /**
         * The platform the game is being played on
         * @type {?ActivityPlatform}
         */
        this.platform = (_b = data.platform) !== null && _b !== void 0 ? _b : null;
        /**
         ...
         * @type {?string}
         */
        this.sessionID = (_c = data.session_id) !== null && _c !== void 0 ? _c : null;
        /**
         * The labels of the buttons of this rich presence
         * @type {string[]}
         */
        this.buttons = (_d = data.buttons) !== null && _d !== void 0 ? _d : [];
        /**
