...
class ApplicationCommand extends Base {
    ...
    static transformOption(option, received) {
        ...
        return {
            ...
            required: (_a = option.required) !== null && _a !== void 0 ? _a : (stringType === 'SUB_COMMAND' || stringType === 'SUB_COMMAND_GROUP' ? undefined : false),
            choices: option.choices,
            options: (_b = option.options) === null || _b === void 0 ? void 0 : _b.map(o => this.transformOption(o, received)),
        };
    }
}
