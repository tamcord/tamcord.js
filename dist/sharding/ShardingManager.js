...
class ShardingManager extends EventEmitter {
    ...
    constructor(file, options = {}) {
        ...
        if (this.totalShards !== 'auto') {
            ...
            if (this.totalShards < 1)
                throw new RangeError('CLIENT_INVALID_OPTION', 'Amount of shards', 'at least 1.');
     ...
     */
    spawn({ amount = this.totalShards, delay = 5500, timeout = 30000 } = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            // Obtain/verify the number of shards to spawn
            if (amount === 'auto') {
                amount = yield Util.fetchRecommendedShards(this.token);
            }
            else {
    ...
    broadcastEval(script, options = {}) {
        if (typeof script !== 'function')
            return Promise.reject(new TypeError('SHARDING_INVALID_EVAL_BROADCAST'));
