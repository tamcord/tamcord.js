...
class Shard extends EventEmitter {
    ...
    constructor(manager, id) {
         ...
         * @type {string[]}
         */
        this.args = (_a = manager.shardArgs) !== null && _a !== void 0 ? _a : [];
        /**
    ...
    spawn(timeout = 30000) {
        ...
        this._evals.clear();
        this._fetches.clear();
        const child = (_a = this.process) !== null && _a !== void 0 ? _a : this.worker;
        /**
     ...
     * @returns {Promise<ChildProcess>}
     */
    respawn({ delay = 500, timeout = 30000 } = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            this.kill();
            if (delay > 0)
                yield Util.delayFor(delay);
    ...
    fetchClientValue(prop) {
        ...
        if (!this.process && !this.worker)
            return Promise.reject(new Error('SHARDING_NO_CHILD_EXISTS', this.id));
        ...
        const promise = new Promise((resolve, reject) => {
            ...
            const listener = message => {
                if ((message === null || message === void 0 ? void 0 : message._fetchProp) !== prop)
                    return;
    ...
    eval(script) {
        ...
        const promise = new Promise((resolve, reject) => {
            ...
            const child = (_a = this.process) !== null && _a !== void 0 ? _a : this.worker;
            const listener = message => {
                if ((message === null || message === void 0 ? void 0 : message._eval) !== script)
                    return;
                child.removeListener('message', listener);
    ...
    _handleMessage(message) {
        if (message) {
            ...
            if (message._sFetchProp) {
                ...
                this.manager.fetchClientValues(message._sFetchProp, message._sFetchPropShard).then(results => this.send(Object.assign(Object.assign({}, resp), { _result: results })), err => this.send(Object.assign(Object.assign({}, resp), { _error: Util.makePlainError(err) })));
                return;
            }
            // Shard is requesting an eval broadcast
            if (message._sEval) {
                const resp = { _sEval: message._sEval, _sEvalShard: message._sEvalShard };
                this.manager._performOnShards('eval', [message._sEval], message._sEvalShard).then(results => this.send(Object.assign(Object.assign({}, resp), { _result: results })), err => this.send(Object.assign(Object.assign({}, resp), { _error: Util.makePlainError(err) })));
                return;
            }
    ...
    _handleExit(respawn = this.manager.respawn) {
         ...
         */
        this.emit('death', (_a = this.process) !== null && _a !== void 0 ? _a : this.worker);
        this.ready = false;
        this.process = null;
        this.worker = null;
        this._evals.clear();
