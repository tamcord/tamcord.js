    ...
    add(roleOrRoles, reason) {
        return __awaiter(this, void 0, void 0, function* () {
            if (roleOrRoles instanceof Collection || Array.isArray(roleOrRoles)) {
                ...
                yield this.client.api.guilds[this.guild.id].members[this.member.id].roles[roleOrRoles].put({ reason });
    ...
    remove(roleOrRoles, reason) {
        return __awaiter(this, void 0, void 0, function* () {
            if (roleOrRoles instanceof Collection || Array.isArray(roleOrRoles)) {
                ...
                yield this.client.api.guilds[this.guild.id].members[this.member.id].roles[roleOrRoles].delete({ reason });
                const clone = this.member._clone();
