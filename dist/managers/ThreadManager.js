...
class ThreadManager extends BaseManager {
    ...
    fetchActive(cache = true) {
        return __awaiter(this, void 0, void 0, function* () {
            const raw = yield this.client.api.channels(this.channel.id).threads.active.get();
            return this._mapThreads(raw, cache);
        });
    }
    _mapThreads(rawThreads, cache) {
        ...
        for (const rawMember of rawThreads.members)
            (_a = threads.get(rawMember.id)) === null || _a === void 0 ? void 0 : _a.members._add(rawMember);
        return {
            threads,
