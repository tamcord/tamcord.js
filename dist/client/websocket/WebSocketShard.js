...
class WebSocketShard extends EventEmitter {
    ...
    connect() {
        ...
        if (((_a = this.connection) === null || _a === void 0 ? void 0 : _a.readyState) === WebSocket.OPEN && this.status === Status.READY) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (((_a = this.connection) === null || _a === void 0 ? void 0 : _a.readyState) === WebSocket.OPEN) {
    ...
    Reason    : ${(_a = event.reason) !== null && _a !== void 0 ? _a : 'No reason received'}`);
    ...
    identifyNew() {
        ...
        const d = Object.assign(Object.assign({}, client.options.ws), { intents: Intents.resolve(client.options.intents), token: client.token, shard: [this.id, Number(client.options.shardCount)] });
